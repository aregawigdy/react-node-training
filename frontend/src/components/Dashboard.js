                  ...
                  <div className="card mini-stat bg-primary text-white">
                    <div className="card-body">
                      <div className="mb-4">
                        ...
                        <h5 className="font-size-16 text-uppercase mt-0 text-white-50">Orders</h5>
                        <h4 className="font-weight-medium font-size-24">1,685 <i className="mdi mdi-arrow-up text-success ml-2" /></h4>
                  ...
                  <div className="card mini-stat bg-primary text-white">
                    <div className="card-body">
                      <div className="mb-4">
                        ...
                        <h5 className="font-size-16 text-uppercase mt-0 text-white-50">Revenue</h5>
                        <h4 className="font-weight-medium font-size-24">52,368 <i className="mdi mdi-arrow-down text-danger ml-2" /></h4>
                  ...
                  <div className="card mini-stat bg-primary text-white">
                    <div className="card-body">
                      <div className="mb-4">
                        ...
                        <h5 className="font-size-16 text-uppercase mt-0 text-white-50">Average Price</h5>
                        <h4 className="font-weight-medium font-size-24">15.8 <i className="mdi mdi-arrow-up text-success ml-2" /></h4>
                  ...
                  <div className="card mini-stat bg-primary text-white">
                    <div className="card-body">
                      <div className="mb-4">
                        ...
                        <h4 className="font-weight-medium font-size-24">2436 <i className="mdi mdi-arrow-up text-success ml-2" /></h4>
                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      <div className="cleafix">
                        <p className="float-left"><i className="mdi mdi-calendar mr-1 text-primary" /> Jan 01 - Jan 31</p>
                      ...
                      <ol className="activity-feed">
                        ...
                        <li className="feed-item">
                          <div className="feed-item-list">
                            ...
                            <span className="activity-text">At vero accusamus et iusto odio dignissimos ducimus qui deleniti atque...<a href="#" className="text-success">Read more</a></span>
                          </div>
                        </li>
                        <li className="feed-item">
                          <div className="feed-item-list">
                        ...
                        <li className="feed-item">
                          <div className="feed-item-list">
                            ...
                            <span className="activity-text">Sed ut perspiciatis omnis iste natus error sit rem.</span>
                          </div>
                        </li>
                      </ol>
                      <div className="text-center">
                      ...
                      <div className="card text-center">
                        <div className="card-body">
                          <div className="py-4">
                            ...
                            <p className="text-muted">Thanks you much for your order.</p>
                            <div className="mt-4">
                      ...
                      <div className="card bg-primary">
                        <div className="card-body">
                          <div className="text-center text-white py-4">
                            <h5 className="mt-0 mb-4 text-white-50 font-size-16">Top Product Sale</h5>
                            <h1>1452</h1>
                    ...
                    <div className="col-md-12">
                      <div className="card">
                        <div className="card-body">
                          ...
                          <p className="text-muted mb-3 pb-4">" Everyone realizes why a new common language would be desirable one could refuse to pay expensive translators it would be necessary. "</p>
                          <div className="float-right mt-2">
                            <a href="#" className="text-primary">
                              <i className="mdi mdi-arrow-right h5" />
                            </a>
                          </div>
                          <h6 className="mb-0"><img src="assets/images/users/user-3.jpg" alt className="avatar-sm rounded-circle mr-2" /> James Athey</h6>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <table className="table table-hover table-centered table-nowrap mb-0">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <div>
                                  <img src="assets/images/users/user-2.jpg" alt className="avatar-xs rounded-circle mr-2" /> Philip Smead
                                </div>
                              </td>
                              <td>15/1/2018</td>
                              <td>$94</td>
                            ...
                            <tr>
                              ...
                              <td>
                                <div>
                                  <img src="assets/images/users/user-3.jpg" alt className="avatar-xs rounded-circle mr-2" /> Brent Shipley
                                </div>
                              </td>
                              <td>16/1/2019</td>
                              <td>$112</td>
                            ...
                            <tr>
                              ...
                              <td>
                                <div>
                                  <img src="assets/images/users/user-4.jpg" alt className="avatar-xs rounded-circle mr-2" /> Robert Sitton
                                </div>
                              </td>
                              <td>17/1/2019</td>
                              <td>$116</td>
                            ...
                            <tr>
                              ...
                              <td>
                                <div>
                                  <img src="assets/images/users/user-5.jpg" alt className="avatar-xs rounded-circle mr-2" /> Alberto Jackson
                                </div>
                              </td>
                              <td>18/1/2019</td>
                              <td>$109</td>
                            ...
                            <tr>
                              ...
                              <td>
                                <div>
                                  <img src="assets/images/users/user-6.jpg" alt className="avatar-xs rounded-circle mr-2" /> David Sanchez
                                </div>
                              </td>
                              <td>19/1/2019</td>
                              <td>$120</td>
                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      <div className="chat-conversation">
                        <ul className="conversation-list" data-simplebar style={{maxHeight: 367}}>
                          ...
                          <li className="clearfix odd">
                            ...
                            <div className="conversation-text">
                              <div className="ctext-wrap">
                                ...
                                <img src="assets/images/small/img-1.jpg" alt height={48} className="rounded mr-2" />
                                <img src="assets/images/small/img-2.jpg" alt height={48} className="rounded" />
                              </div>
                            </div>
                          </li>
                        </ul>
