                    ...
                    <div className="panel panel-success">
                        ...
                        <form className="form-horizontal" encType="multipart/form-data" role="form" method="POST" name="form_validation">
                            ...
                            <div className="col-md-6 flex-fill">
                                <input id="name" type="text" className="form-control" placeholder="姓" name="last_name" required autofocus />
                            </div>
                            <div className="col-md-6 flex-fill">
                                <input id="name" type="text" className="form-control" placeholder="名" name="first_name" required autofocus />
                            </div>
                            </div>
                            <div className="form-group d-flex">
                            <div className="col-md-6 flex-fill">
                                <input id="name" type="text" className="form-control" placeholder="セイ" name="last_name_kana" required autofocus title="katakana only" />
                            </div>
                            <div className="col-md-6 flex-fill">
                                <input id="name" type="text" className="form-control" placeholder="メイ" name="first_name_kana" required autofocus />
                            </div>
                            </div>
                            {/*</div>
                            </div>*/}
                            <div className="form-group d-flex">
                            <div className="col-md-6 flex-fill">
                                <input id="name" type="email" className="form-control" placeholder="メールアドレス" name="email" required autofocus />
                            </div>
                            <div className="col-md-6 flex-fill">
                                <input id="name" type="password" className="form-control" placeholder="パスワード" name="password" required autofocus />
                            </div>
                            </div>
                            <div className="form-group d-flex">
                            <div className="col-sm-6">
                                <select required="required" name="role" className="form-select form-select-lg placeholder_select">
                                <option value hidden>ユーザーロール選択</option>
                                {/* <option value="システム管理者" >システム管理者</option> */}
                                <option value="管理者">Admin - 管理者</option>
                                {/* <option value="販売代理店">Dealer - 販売代理店</option> */}
                                <option value="利用者">End User - 利用者</option>
                                <option value="施工者">Installer - 施工者</option>
                                {/* <option value="監視者">Surveillance - 監視者</option>
                                        <option value="メンテナンス者">Maintainer - メンテナンス者</option>
                                        <option value="投資者">Investor - 投資者</option>
                                        <option value="保険会社">Insurance - 保険会社</option> */}
                                </select>
                            </div>
                            </div>
                            <b>住所:</b>
                            ...
                            <div className="panel-body">
                                ...
                                <div className="col-sm-3 flex-fill">
                                    <input type="text" className="form-control" placeholder="郵便番号" name="zip_code" required autofocus />
                                ...
                                <div className="col-md-6 flex-fill">
                                    <input type="text" className="form-control" placeholder="マンション/ビル名" name="apartment" required autofocus />
                                </div>
                                </div>
                                <div className="form-group d-flex">
                                <div className="col-sm-6">
                                    <input type="text" className="form-control" placeholder="電話番号" name="phoneNum" required autofocus onchange="phoneValidate()" />
                                    <span id="phone_val" />
                            ...
                            <div className="form-group d-flex">
                            <div className="col-md-6 flex-fill">
                                <input type="text" className="form-control" placeholder="会社名" name="company_name" required autofocus />
                            </div>
                            <div className="col-md-6 flex-fill">
                                <input type="text" className="form-control" placeholder="部署名" name="department_name" required autofocus />
                            </div>
                            </div>   
                            <hr />
