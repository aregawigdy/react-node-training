              ...
              <div className="navbar-brand-box">
                <Link to='/home' className="logo logo-dark">
                  <span className="logo-sm">
                    <img src="assets/images/alt_logo.png" alt height={22} />
                  </span>
                  <span className="logo-lg">
                    <img src="assets/images/alt_logo.png" alt height={35} />
                  </span>
                </Link>
            ...
            <div className="d-flex">
              ...
              <div className="dropdown d-inline-block">
                <button type="button" className="btn header-item waves-effect" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <img className="rounded-circle header-profile-user" src="assets/images/alt_logo.png" alt="Header Avatar" />
                </button>
                <div className="dropdown-menu dropdown-menu-right">
                  {/* item*/}
